...
const upcomingProducts = [
  { name: "All-Natural Popcorn", description: "Variety of natural flavors" },
  { name: "Fruit Ice Pops", description: "Real fruit, no artificial colors" },
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover our range of natural, healthy beverages crafted with the finest ingredients
            </p>
          </div>

          <div ref={productRef} className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl px-4">
          ...
          <p className="text-xl md:text-2xl animate-on-scroll" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll">
              ...
              <p className="text-xl mb-8 opacity-90">
                Frippy brings you the authentic taste of real fruits with no compromises
              </p>
            ...
            <div className="grid grid-cols-3 gap-4 animate-on-scroll">
              {products.slice(0, 3).map((product, index) => (
                <div key={index} className="float-animation" style={{ animationDelay: `${index * 0.5}s` }}>
                  <CloudinaryImage
                    src={product.src}
                    alt={product.alt}
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Exciting new products are in development to expand our healthy lifestyle range
            </p>
          </div>
