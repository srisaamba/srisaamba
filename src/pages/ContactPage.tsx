...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      details: ["+91 8054430418"],
    },
    {
      icon: Mail,
      title: "Email",
      details: ["hello@srisaamba.com"],
    },
    {
      icon: Clock,
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select onValueChange={handleSelectChange}>
                      ...
                      <SelectContent>
                        <SelectItem value="frippy">
                          Frippy Fruit Drinks
                        </SelectItem>
                        <SelectItem value="drfiber">
                          Dr Fiber Prebiotic Sodas
                        </SelectItem>
            ...
            <div className="animate-on-scroll">
              ...
              {/* <div className="mt-12 bg-gradient-to-r from-primary to-primary-glow rounded-3xl p-8 text-white">
                ...
                <p className="text-lg opacity-90 mb-6">
                  Whether you're interested in our current products or exploring
                  partnership opportunities, we're excited to hear from you.
                </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-on-scroll">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-soft border border-gray-100">
            ...
            <div className="text-gray-600 space-y-2">
              <p>
                <strong>CIN:</strong> U11049KA2024PTC192614
              </p>
              <p>
